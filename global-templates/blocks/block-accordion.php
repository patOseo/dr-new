		...
		<?php $i = 1; while(have_rows('accordion')): the_row(); ?>
			...
			<div class="card mb-3">
				<div class="card-header shadowbox hover position-relative" id="heading<?php echo $i; ?>">
					<?php echo $htmltagopen; ?><p class="btn stretched-link mb-0" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse<?php echo $i; ?>"><i class="fa fa-plus"></i> <?php echo get_sub_field('title'); ?></p><?php echo $htmltagclose; ?>
				</div>
