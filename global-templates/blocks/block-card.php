...
<div class="shadowbox card <?php if($no_min == 1) { echo 'no-min-height'; } ?> <?php if(get_field('card_link')) { echo 'hover'; } ?>">
	...
	<?php if(get_field('card_subtitle')): ?><p class="card-subtitle"><?php echo get_field('card_subtitle'); ?></p><?php endif; ?>
	<?php if(get_field('card_content')): ?><p class="card-content"><?php echo get_field('card_content'); ?></p><?php endif; ?>
</div>